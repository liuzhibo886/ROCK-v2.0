...
public class Result<T> implements Serializable {
	 ...
	 */
	public void error(RockEnum busEnum) {
		setEnum(busEnum);
	}
	 ...
	 */
	public void error(RockEnum msgEnum, String errMsg) {
		setEnum(msgEnum);
		setErrMsgs(errMsg);
	}
	 ...
	 * @param data    内容
	 */
	public void error(RockEnum msgEnum, String errMsg, T data) {
		setEnum(msgEnum);
		setErrMsgs(errMsg);
		this.data = data;
	}
	...
	public Result(RockEnum msgEnum, T data) {
		setEnum(msgEnum);
	...
	public Result(RockEnum msgEnum) {
	 ...
	 * @param msgEnum
	 */
	public void setEnum(RockEnum msgEnum) {
