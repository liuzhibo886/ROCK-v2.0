...
public class UtilCalendar {
	...
	private static Date solarFromInt(long g) {
		...
		String dateStr = solar.getSolarYear() + "-" + solar.getSolarMonth() + "-" + solar.getSolarDay() + " 00:00:00";

		return UtilDate.getDateByString(dateStr, "yyyy-MM-dd hh:mm:ss");
	}

	/**
	 * 农历转公历
	 */
	public static Date lunarToSolar(int yy, int mm, int dd, boolean flag) {
		int days = lunar_month_days[yy - lunar_month_days[0]];
		...
		int solar11 = solar_1_1[yy - solar_1_1[0]];
