 ...
 * 
 * @author lzb
 * @Date 2019年8月1日 下午2:08:46
 */
public class JavaCodeCalculateRows {
	...
	static long importLines = 0; // 代码行

	public static void main(String[] args) throws Exception {
		File f = new File("D:\\java\\eclipse\\lzb2"); // 目录
		String type = ".java";// 查找什么类型的代码，如".java"就是查找以java开发的代码量，".php"就是查找以PHP开发的代码量
		JavaCodeCalculateRows.treeFile(f, type);
		...
		System.out.println("import数量：" + importLines);
		if (classcount == 0) {
