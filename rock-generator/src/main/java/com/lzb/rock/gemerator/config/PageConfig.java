...
public class PageConfig {
	...
	public void init() {
		pagePathTemplate = "\\src\\main\\webapp\\WEB-INF\\view\\" + contextConfig.getProjectName() + "\\" + contextConfig.getModuleName() + "\\{}\\{}.html";
		pageAddPathTemplate = "\\src\\main\\webapp\\WEB-INF\\view\\" + contextConfig.getProjectName() + "\\" + contextConfig.getModuleName() + "\\{}\\{}_add.html";
		pageEditPathTemplate = "\\src\\main\\webapp\\WEB-INF\\view\\" + contextConfig.getProjectName() + "\\" + contextConfig.getModuleName() + "\\{}\\{}_edit.html";
		pageJsPathTemplate = "\\src\\main\\webapp\\WEB-INF\\view\\" + contextConfig.getProjectName() + "\\" + contextConfig.getModuleName() + "\\{}\\{}.js";
		pageInfoJsPathTemplate = "\\src\\main\\webapp\\WEB-INF\\view\\" + contextConfig.getProjectName() + "\\" + contextConfig.getModuleName() + "\\{}\\{}_info.js";
	}
